...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fileTree.setGeometry(QtCore.QRect(0, 70, 1011, 521))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(230, 10, 411, 61))
        ...
        self.fileButtons.addWidget(self.toolButton_2)
        ...
        self.toolButton.clicked.connect(MainWindow.file_refresh)
        ...
        self.toolButton_2.clicked.connect(MainWindow.file_cut)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton_2.setText(_translate("MainWindow", "Cut"))
        ...
        self.taskTree.headerItem().setText(0, _translate("MainWindow", "文件名"))
        self.taskTree.headerItem().setText(1, _translate("MainWindow", "上传/下载"))
        self.taskTree.headerItem().setText(2, _translate("MainWindow", "下载速度"))
